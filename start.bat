...
start "LockIn-Backend" powershell -Command "$env:LOCKIN_WATER_TRIGGER_ENABLED='1'; $env:LOCKIN_WATER_TRIGGER_PORT='COM5'; $env:LOCKIN_WATER_TRIGGER_BAUD='115200'; python -m uvicorn main:app --reload"
